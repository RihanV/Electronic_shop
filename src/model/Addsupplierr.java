...
import backend.pages.AddSupplierBackend;
...
public class Addsupplierr extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Addsupplierr.class.getName());
    private final AddSupplierBackend backend = new AddSupplierBackend();
   ...
   public Addsupplierr() {
    ...
    private void onSaveSupplier() {
        ...
        s.setName(name);
        s.setPhone(contact.isEmpty() ? null : contact);

        try {
            int newId = backend.addSupplier(s);
            JOptionPane.showMessageDialog(this, "Supplier added successfully (ID: " + newId + ").");
            jTextField1.setText("");
            jTextField2.setText("");
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "Failed to add supplier: " + ex.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Create a supplier and use it when adding products.");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Addsupplierr().setVisible(true));
    }
